...
public class FollowThePath : MonoBehaviour
{
    ...
    public void SetPath()
    {
        ...
        // Move the enemy to a point outside the camera's viewport
        Camera mainCamera = Camera.main;
        Vector3 outsideViewportPosition = mainCamera.ViewportToWorldPoint(new Vector3(-0.1f, 0.5f, mainCamera.nearClipPlane));
        transform.position = outsideViewportPosition;

        // Alternatively, you can place the enemy at the start of the path
